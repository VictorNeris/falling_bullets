...
class BF2Object(object):
	...
	def delete(self):
		...
		# modified to make delete function in cmdstack
		else:
			self._cmdStack.append("self.delete()")
...
# Creates an object spawner to spawn the object on place without any delay
def spawnObject(template, position, rotation=(0.0,0.0,0.0)):
